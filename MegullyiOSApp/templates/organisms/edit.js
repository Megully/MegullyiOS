...
{id:1,name:"君の名はスタンプラリー",stampPoint:10,progress:6,date:new Date(2021, 3, 31, 20, 59, 59, 999),img:require('../../assets/img/yourName.jpg')},
{id:2,name:"エモい廃墟",stampPoint:7,progress:2,date:new Date(2021, 3, 15, 15, 59, 59, 999),img:require('../../assets/img/ruins.jpg')},
{id:3,name:"中央沿線駅巡り",stampPoint:18,progress:5,date:new Date(2021, 3, 6, 18, 59, 59, 999),img:require('../../assets/img/tokyoStation.jpg')},
...
const Item = ({name,stampPoint,progress,img}) => (
  <View>
    <MyRallyList name={name} stampPoint={stampPoint} progress={progress} img={img}/>
  </View>
);
export default function Edit() {
  const renderItem = ({ item }) => (
    <Item name={item.name} stampPoint={item.stampPoint} progress={item.progress} img={item.img}/>
  );
  return (
