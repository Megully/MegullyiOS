...
{id:'3',name:"四国八十八カ所",stampPoint:7,progress:2,date:new Date(2021, 3, 15, 15, 59, 59, 999),img:require('../../assets/img/shikoku.png'),author:'masa2004'},
...
{id:'5',name:"珍しい矢印標識",stampPoint:12,progress:11,date:new Date(2021, 3, 6, 18, 59, 59, 999),img:require('../../assets/img/arrowSign.jpg'),author:'MugiSus'},
{id:'6',name:"スーパー銭湯",stampPoint:6,progress:2,date:new Date(2021, 3, 6, 18, 59, 59, 999),img:require('../../assets/img/superSento.jpg'),author:'めぐる'},
{id:'7',name:"呪術廻戦OP聖地巡り(*'▽')",stampPoint:6,progress:2,date:new Date(2021, 3, 6, 18, 59, 59, 999),img:require('../../assets/img/gojo.jpg'),author:'💜愉廼💜'},
{id:'8',name:"♥ℍ𝕒𝕣𝕒𝕛𝕦𝕜𝕦 𝕡𝕙𝕠𝕥𝕠 𝕤𝕡𝕠𝕥♥",stampPoint:5,progress:1,date:new Date(2021, 3, 4, 17, 59, 59, 999),img:require('../../assets/img/harajuku.jpeg'),author:'夢叶'},
